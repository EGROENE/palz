...
const createEvent = (eventData: TEvent): Promise<Response> => {
  ...
  const raw = JSON.stringify({
    ...
    "eventDateMidnightUTCInMS": eventData.eventDateMidnightUTCInMS,
    "eventTimeAfterMidnightUTCInMS": eventData.eventTimeAfterMidnightUTCInMS,
    "eventDateTimeInMS": eventData.eventDateTimeInMS,
