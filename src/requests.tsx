...
const createEvent = (eventData: TEvent): Promise<Response> => {
  ...
  const raw = JSON.stringify({
    ...
    "eventDateMidnightUTCUnix": eventData.eventDateMidnightUTCUnix,
    "eventTimeAfterMidnightUTCUnix": eventData.eventTimeAfterMidnightUTCUnix,
    "eventDateTimeUnix": eventData.eventDateTimeUnix,
